	...
	phi(adist(rng))
{
	...
	if (!IsStaticInitialized())
	{
		...
		model.vertices[0].color = { 1,31,75 };
		model.vertices[1].color = { 3,57,108 };
		model.vertices[2].color = { 0,91,150 };
		model.vertices[3].color = { 100,151,177 };
		model.vertices[4].color = { 179,205,224 };
		model.vertices[5].color = { 179,205,224 };
